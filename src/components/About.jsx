...
import avatar1b from '../assets/ph-avatar-002.png'
import avatar2 from '../assets/avatar2.jpg'
import avatar2b from '../assets/ph-avatar-001.png'
...
const About = () => {
  ...
  const styles = {
    ...
    avatarContainer:"h-[44vh] flex flex-col justify-center items-center m-2 ",
      // avatarContainer:" h-[20-vh] flex-col justify-center items-center m-2 pl-2",
     cardContainer: "lg:w-5/12 md:h-[50vh] py-4 px-2 flex flex-col md:flex-row items-center text-center md:text-start   ",
      ...
      <div className="w-full  relative flex flex-col lg:flex-row p-4 justify-center gap-2">
        ...
        <div className={ `${styles.cardContainer} bg-[#00F59B] `}>
          <div className={`${styles.avatarContainer}`}>
            <img src={avatar1b} alt="" className='h-[100%] ' />
          </div>
          <div className=' flex flex-col justify-center p-4 w-[60%] '>
            <div>
              ...
              <h1 className=' font-semibold text-amd'>Formación en Deporte </h1>  
        ...
        <div className={ `${styles.cardContainer} bg-[#00F59B] `}>
          <div className={`${styles.avatarContainer}`}>
            <img src={avatar2b} alt="" className='h-[100%] ' />
          </div>
          <div className=' flex flex-col justify-center p-4 w-[60%] '>
            <div>
              <div className={`${styles.titleCard}`} >
              ...
              <h1 className=' font-semibold text-amd'>Formación en Entrenamiento personalizado </h1>  
